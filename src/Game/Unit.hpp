...
namespace sw::game
{
    ...
    public:
        ...
        void setIdle(const bool value) { _idle = value; }
        ...
        void setCurrentPosition(const Position currentPosition) { _currentPosition = currentPosition; }

        bool tryGetTargetPosition(Position& targetPosition) const;

        void setTargetPosition(const Position targetPosition) { _targetPosition = targetPosition; }

        void resetTargetPosition() { _targetPosition.reset(); }
