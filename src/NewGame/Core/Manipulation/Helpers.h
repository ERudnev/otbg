...
namespace swexp::core::manipulation
{
    ...
    template <typename Meta>
    auto try_get(api::context::Reading, typename Meta::Id) -> const typename Meta::State*;

    template <typename Meta>
    auto try_get(api::context::Writing, typename Meta::Id) -> typename Meta::State*;
}
...
namespace swexp::core::manipulation
{
    ...
    template <typename Meta>
    auto try_get(api::context::Reading context, typename Meta::Id id) -> const typename Meta::State*
    {
        const auto& elements = context.state.template line<Meta>().elements;
    ...
    template <typename Meta>
    auto try_get(api::context::Writing context, typename Meta::Id id) -> typename Meta::State*
    {
